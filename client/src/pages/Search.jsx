...
//           >
//             Find Your <span className="text-green-400">Dream Home</span> Today
//           </motion.h1>
//           <motion.p
//             className="text-lg md:text-xl max-w-2xl text-gray-200 drop-shadow-md"
...
//             <Link
//               to="/search"
//               className="mt-6 bg-green-500 hover:bg-green-600 transition duration-200 ease-in-out text-white px-8 py-3 rounded-full text-lg shadow-md"
//             >
//               Start Exploring
//             </Link>
//           </motion.div>
